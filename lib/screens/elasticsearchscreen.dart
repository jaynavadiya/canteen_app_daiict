...
class ElasticSearchDelegate extends SearchDelegate {
  ...
  Future searchElasticServer(searchQuery) async {
    final transport = HttpTransport(
        url:
            'https://edcfad884ba84863b44035965688d519.us-central1.gcp.cloud.es.io:9243',
        authorization:
            basicAuthorization("elastic", "uRkFtoiKfJSCqd4Vnw9EcDt2"));
    ...
    //     source: 'locations',
    //     '_doc',
    //     elastic.Query.term('city', ['$searchQuery']),
    //     source: true);
...
class DisplaySearchResult extends StatelessWidget {
  ...
  // DisplaySearchResult({Key key, this.name, this.appearanceDate, this.powers})
  //     : super(key: key);
